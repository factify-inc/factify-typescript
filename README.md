...
```bash
npm add https://github.com/factify-inc/factify-typescript
```

### PNPM

```bash
pnpm add https://github.com/factify-inc/factify-typescript
```

### Bun

```bash
bun add https://github.com/factify-inc/factify-typescript
```

### Yarn

```bash
yarn add https://github.com/factify-inc/factify-typescript
```
