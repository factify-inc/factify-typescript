 ...
 */
export function sharingCreateShareLink(
  client: FactifyCore,
  request: operations.CreateShareLinkRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateShareLinkResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CreateShareLinkRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateShareLinkResponse$inboundSchema, {
      key: "Result",
    }),
