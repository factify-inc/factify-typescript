...
export function sharingList(
  ...
  Result<
    operations.ListDocumentAccessResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListDocumentAccessRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListDocumentAccessResponse$inboundSchema, {
      key: "Result",
    }),
