 ...
 */
export function documentsExport(
  client: FactifyCore,
  request: operations.ExportDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExportDocumentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ExportDocumentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1beta/documents/{document_id}/export")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExportDocumentResponse$inboundSchema, {
      key: "Result",
    }),
