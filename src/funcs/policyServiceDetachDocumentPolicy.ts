 ...
 */
export function policyServiceDetachDocumentPolicy(
  client: FactifyCore,
  request: operations.DetachDocumentPolicyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DetachDocumentPolicyResponse,
    | FactifyError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DetachDocumentPolicyRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DetachDocumentPolicyResponse$inboundSchema, {
