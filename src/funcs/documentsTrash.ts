 ...
 */
export function documentsTrash(
  client: FactifyCore,
  request: operations.TrashDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TrashDocumentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.TrashDocumentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1beta/documents/{document_id}/trash")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TrashDocumentResponse$inboundSchema, {
      key: "Result",
    }),
