 ...
 */
export function documentsProcess(
  client: FactifyCore,
  request: operations.ProcessDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ProcessDocumentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ProcessDocumentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1beta/documents/{document_id}/process")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ProcessDocumentResponse$inboundSchema, {
      key: "Result",
    }),
