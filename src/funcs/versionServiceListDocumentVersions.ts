 ...
 */
export function versionServiceListDocumentVersions(
  client: FactifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListDocumentVersionsRequest$outboundSchema, value),
  ...
  >(
    M.json(200, operations.ListDocumentVersionsResponse$inboundSchema, {
      key: "factify.api.v1beta.ListVersionsResponse",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
