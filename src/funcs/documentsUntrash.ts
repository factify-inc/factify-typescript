 ...
 */
export function documentsUntrash(
  client: FactifyCore,
  request: operations.UntrashDocumentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UntrashDocumentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UntrashDocumentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1beta/documents/{document_id}/untrash")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UntrashDocumentResponse$inboundSchema, {
      key: "Result",
    }),
