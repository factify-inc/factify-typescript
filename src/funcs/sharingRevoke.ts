 ...
 */
export function sharingRevoke(
  client: FactifyCore,
  request: operations.RevokeDocumentAccessRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RevokeDocumentAccessResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RevokeDocumentAccessRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RevokeDocumentAccessResponse$inboundSchema, {
      key: "Result",
    }),
