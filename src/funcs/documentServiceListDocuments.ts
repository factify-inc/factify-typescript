 ...
 */
export function documentServiceListDocuments(
  client: FactifyCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListDocumentsRequest$outboundSchema),
        value,
      ),
  ...
  const query = encodeFormQuery({
    ...
    "created.after.nanos": payload?.["created.after.nanos"],
    "created.after.seconds": payload?.["created.after.seconds"],
  ...
  >(
    M.json(200, operations.ListDocumentsResponse$inboundSchema, {
      key: "factify.api.v1beta.ListDocumentsResponse",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
