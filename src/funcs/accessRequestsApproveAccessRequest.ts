...
export function accessRequestsApproveAccessRequest(
  ...
  Result<
    operations.ApproveAccessRequestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ApproveAccessRequestRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/v1beta/documents/{document_id}/access-requests/{access_request_id}/approve",
  )(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ApproveAccessRequestResponse$inboundSchema, {
      key: "Result",
    }),
