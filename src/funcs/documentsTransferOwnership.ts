 ...
 */
export function documentsTransferOwnership(
  client: FactifyCore,
  request: operations.TransferDocumentOwnershipRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TransferDocumentOwnershipResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.TransferDocumentOwnershipRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1beta/documents/{document_id}/transfer")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TransferDocumentOwnershipResponse$inboundSchema, {
      key: "Result",
    }),
