...
async function run() {
  const result = await factify.organizations.addOrganizationMember({
    organizationId: "<id>",
    body: {
      role: "owner",
      userId: "<id>",
...
```typescript
import { FactifyCore } from "@factify/sdk/core.js";
import { organizationsAddOrganizationMember } from "@factify/sdk/funcs/organizationsAddOrganizationMember.js";
...
async function run() {
  const res = await organizationsAddOrganizationMember(factify, {
    organizationId: "<id>",
    body: {
      role: "owner",
      userId: "<id>",
  ...
  if (res.ok) {
    ...
    console.log("organizationsAddOrganizationMember failed:", res.error);
  }
}
