...
<!-- UsageSnippet language="typescript" operationID="createDocument" method="post" path="/v1beta/documents" -->
```typescript
import { Factify } from "@factify/sdk";
...
<!-- UsageSnippet language="typescript" operationID="updateDocument" method="patch" path="/v1beta/documents/{document_id}" -->
```typescript
import { Factify } from "@factify/sdk";
