...
<!-- UsageSnippet language="typescript" operationID="getUserPreferences" method="get" path="/v1beta/user-preferences" -->
```typescript
...
**Promise\<[operations.GetUserPreferencesResponse](../../models/operations/getuserpreferencesresponse.md)\>**
