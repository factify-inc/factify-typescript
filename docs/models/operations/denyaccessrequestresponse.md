...
```typescript
import { DenyAccessRequestResponse } from "@factify/sdk/models/operations";
...
| `result`                                                                                     | [components.DenyAccessRequestResponse](../../models/components/denyaccessrequestresponse.md) | :heavy_check_mark:                                                                           | N/A                                                                                          |