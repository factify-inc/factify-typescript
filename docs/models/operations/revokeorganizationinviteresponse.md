...
```typescript
import { RevokeOrganizationInviteResponse } from "@factify/sdk/models/operations";
...
| `result`                                                                                                   | [components.RevokeOrganizationInviteResponse](../../models/components/revokeorganizationinviteresponse.md) | :heavy_check_mark:                                                                                         | N/A                                                                                                        |