...
| `acceptedBy`                                                                                                 | [components.User](../../models/components/user.md)                                                           | :heavy_minus_sign:                                                                                           | User represents a human user account.<br/> Returned by GetUser (endpoint deferred).                          |                                                                                                              |
...
| `sender`                                                                                                     | [components.User](../../models/components/user.md)                                                           | :heavy_check_mark:                                                                                           | User represents a human user account.<br/> Returned by GetUser (endpoint deferred).                          |                                                                                                              |
| `status`                                                                                                     | [components.OrganizationInviteStatus](../../models/components/organizationinvitestatus.md)                   | :heavy_check_mark:                                                                                           | N/A                                                                                                          |                                                                                                              |